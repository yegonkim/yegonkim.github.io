...
Although the project started out from a personal conviction that world models would not be necessary for future AI sytems, I am now more open to the possibility that future AI systems will actually have world models, due to the problems with non-stationarity discussed above.
